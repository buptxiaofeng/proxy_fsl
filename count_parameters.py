...
from feat.models.ctmnet import CTMNet
...
ctmnet = CTMNet(model_type = "ConvNet4",  num_shot = 5, num_way = 5, num_query = 15)
num_parameters = sum(p.numel() for p in ctmnet.parameters() if p.requires_grad)
print("The number of trainable parameter: CTMNet:" + str(num_parameters))
